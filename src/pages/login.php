...
<body class="bg-white vh-100 d-flex flex-column justify-content-between">
    ...
    <?php } else if (isset($_SESSION['registerSuccess'])) { ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Success!</strong> <?= $_SESSION['registerSuccess'] ?>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    <?php } ?>
    <?php
    ...
    <main class="container mt-5">
        <h1 class="text-center fw-bold mb-3">Login Akun</h1>
        <form action="./controller/loginAction.php" method="POST">
            <div class="mb-3">
                ...
                <div hidden class="alert alert-danger alert-dismissible fade show mt-1 " role="alert">
                    <strong>Perhatian!</strong> Email tidak valid.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            </div>
            <div class="mb-3 position-relative">
                ...
                <div hidden class="alert alert-danger alert-dismissible fade show mt-1 " role="alert">
                    <strong>Perhatian!</strong> Password salah!
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            </div>
            ...
            <div class="d-flex w-100 align-content-center justify-content-center mt-3">
                <span class="text-muted me-2">Belum memiliki akun?</span>
                <a href="./register.php" class="text-decoration-none text-primary fw-bold">Daftar Sekarang</a>
            </div>
            <hr class="my-4">
            <div class="d-flex text-center w-100 align-content-center justify-content-center mt-3">
                <span class="text-muted me-2">Dengan login, Anda menyetujui</span>
