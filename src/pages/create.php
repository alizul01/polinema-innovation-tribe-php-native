...
<nav class="navbar navbar-expand-lg sticky-lg-top bg-white">
    ...
    <section class="bg-secondary p-3">
        <div class="row justify-content-center text-center">
            <div id="header" class="col-lg-4 col-md-12">
                ...
                <h1 class="fw-bold text-white">Idea Creation Box</h1>
                <p class="text-light fw-light">
                    Ini adalah titik awal dari ide-ide kreatif yang akan menjadi langkah awal untuk membangun masa depanmu.
                </p>
            </div>
        </div>
    </section>
    <?php if (isset($_SESSION['createSuccess']) == true) { ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Success!</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    <?php } else if (isset($_SESSION['createFailed']) == true) { ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <main class="container-fluid pt-5 pb-5 justify-content-center bg-white">
        <form method="post" class="container" action="./controller/createAction.php" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-8">
                    <div class="form-floating mb-3  bg-white">
                        <input name="judul" type="text" class="form-control" id="floatingInput" placeholder="Judul Ide" required>
                        <label for="floatingInput">Judul Ide</label>
                    </div>
                    <div class="form-floating mb-3 bg-white">
                        <select name="kategori" class="form-select  mt-2" aria-label="Default select example" required>
                    ...
                    <div class="form-floating mb-3">
                        <textarea name="content" class="form-control bg-white" placeholder="Deskripsi Ide" id="editor" style="height: 100px"></textarea>
                    </div>
